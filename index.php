                            ...
                            <div class="modal-dialog modal-lg modal-dialog-centered">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <div id="ekyc_result" style="display: none;">
                                            <div class="container-fluid">
                                                <div class="row">
                                                    <div class="col-6">
                                                        <center><img id="ekyc_photo" height="430px" width="334px"></img></center>
                                                    </div>
                                                    <div class="col-6">
                                                        <table class="table table-bordered">
                                                            <tr>
                                                                <td colspan="2"><center>Personal Information</center></td>
                                                            </tr>
                                                            <tr>
                                                                <td>Last Name</td>
                                                                <td id="ekyc_last_name"">Last Name</td>
                                                            </tr>
                                                            <tr>
                                                                <td>First Name</td>
                                                                <td id="ekyc_first_name"">First Name</td>
                                                            </tr>
                                                            <tr>
                                                                <td>Middle Name</td>
                                                                <td id="ekyc_middle_name"">Middle Name</td>
                                                            </tr>
                                                            <tr>
                                                                <td>Suffix</td>
                                                                <td id="ekyc_suffix"">Suffix</td>
                                                            </tr>
                                                            <tr>
                                                                <td>Date of Birth</td>
                                                                <td id="ekyc_dob"">Date of Birth</td>
                                                            </tr>
                                                            <tr>
                                                                <td>Phone Number</td>
                                                                <td id="ekyc_phone_number"">Phone Number</td>
                                                            </tr>
                                                            <tr>
                                                                <td>Email</td>
                                                                <td id="ekyc_email"">Email</td>
                                                            </tr>
                                                            <tr>
                                                                <td>Age</td>
                                                                <td id="ekyc_age"">Age</td>
                                                            </tr>
                                                            <tr>
                                                                <td>Marital Status</td>
                                                                <td id="ekyc_marital_status"">Marital Status</td>
                                                            </tr>
                                                        </table>
                                                    </div>
                                                    <div class="col-12">
                                                    ...
                                                    <div class="col-12">
                                                        <table class="table table-bordered">
                                                            <tr>
                                                                <td>Country</td>
                                                                <td id="ekyc_country"">Country</td>
                                                            </tr>
                                                            <tr>
                                                                <td>Present Address</td>
                                                                <td id="ekyc_present_address"">Present Address</td>
                                                            </tr>
                                                            <tr>
                                                                <td>Province</td>
                                                                <td id="ekyc_province"">Province</td>
                                                            </tr>
                                                            <tr>
                                                                <td>Municipality</td>
                                                                <td id="ekyc_municipality"">Municipality</td>
                                                            </tr>
                                                            <tr>
                                                                <td>Barangay</td>
                                                                <td id="ekyc_barangay"">Barangay</td>
                                                            </tr>
                                                            <tr>
                                                                <td>Postal Code</td>
                                                                <td id="ekyc_postal_code"">Postal Code</td>
                                                            </tr>
                                                            <tr>
                                                                <td>Blood Type</td>
                                                                <td id="ekyc_blood_type"">Blood Type</td>
                                                            </tr>
                                                        </table>
                                                    </div>
                                                </div>
